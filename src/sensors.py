...
class RGB_Camera:
    ...
    def attach_rgb_camera(self, world, vehicle, sensor_dict):
        ...
        # Use both location and rotation from the sensor dictionary
        location = carla.Location(x=sensor_dict.get('location_x', 0.0), y=sensor_dict.get('location_y', 0.0), z=sensor_dict.get('location_z', 0.0))
        rotation = carla.Rotation(pitch=sensor_dict.get('rotation_pitch', 0.0), yaw=sensor_dict.get('rotation_yaw', 0.0), roll=sensor_dict.get('rotation_roll', 0.0))
