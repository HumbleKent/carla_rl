...
CAMERA_VIEW             = "front" # choices: 'front', 'bev'
BEV_HEIGHT              = 32 # Height of bird eye view camera same as spectator view (meters)
BEV_FOV                 = 77    # Field of view for BEV camera (narrower means zoomed in)
...
ENV_CONE_LAYOUT_FILE    = 'env/cone_spawn.json'
ENV_CONE_THRESHOLD      = 3.0
ENV_SPEED_LIMIT         = 50
