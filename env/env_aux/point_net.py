...
#     sim_data = np.random.rand(500, 4)
    
#     sim_data = sim_data[:, :-1]
#     sim_data = sim_data.transpose([1, 0])
    
#     sampler = FarthestSampler()
#     sim_data, _ = sampler.sample(sim_data, 500)
    
#     print('sim data', sim_data.shape)
    
#     sim_data = torch.from_numpy(sim_data).float()
#     sim_data = sim_data.unsqueeze(0)
    
#     pointfeat = PointNetfeat(global_feat=True)
#     pointfeat = pointfeat.eval()
    
#     out, _, _ = pointfeat(sim_data)
#     print('global feat', out.cpu().data.numpy().shape)